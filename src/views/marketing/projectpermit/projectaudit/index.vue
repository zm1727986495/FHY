		...
		<el-card class="lvs">
            ...
            <auditcompon ref="auditcompon">
                <div class="btn_list_1">
                    <!-- <el-button size="small" class="button-96" @click="printFun"  v-if="btnJurisdiction.projectaudit_print">打印</el-button>  -->
                    <el-button size="small" class="button-96" @click="exportFun"  v-if="btnJurisdiction.projectaudit_export">导出</el-button>
                </div>
            </auditcompon>
      	</el-card>
    </div>
