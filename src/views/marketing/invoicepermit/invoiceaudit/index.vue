		...
		<el-card class="lvs">
            ...
            <auditcompon ref="auditcompon">
                <div class="btn_list_1">
                    <!-- <el-button size="small" class="button-96" @click="printFun"  v-if="btnJurisdiction.invoiceaudit_print">打印</el-button>  -->
                    <el-button size="small" class="button-96" @click="exportFun"  v-if="btnJurisdiction.invoiceaudit_export">导出</el-button>
                </div>
            </auditcompon>
      	</el-card>
    </div>
...
export default {
  ...
  // name: 'procurement',
	...
	// },
	// created() { 
    //     this.downFile = module.dev.proxyTable['/api'].target + '/api/pc/invoiceApply/exportInvoiceApply?orderApplyIds=';
    // },
    activated(){
        // 头部面包屑
        this.navList = this.$route.meta;
	...
	methods: {
        ...
        // 打印
        printFun() {
            this.$print(this.$refs.auditcompon.$refs.print)
        },
        // 导出操作按钮
		exportFun() {
