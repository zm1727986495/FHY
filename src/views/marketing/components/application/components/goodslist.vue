    ...
    <div class="goodslist">
        ...
        <div class="table_list lvs attribute m-top20">
            <el-table
                ...
                <el-table-column prop="classifyName" label="商品分类" width="240" sortable align="center"></el-table-column>
                <el-table-column prop="companyName" label="供应商" width="240" sortable align="center"></el-table-column>
