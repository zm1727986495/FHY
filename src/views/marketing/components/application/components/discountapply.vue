<template>
  ...
  <div class="disapply">
    ...
    <!-- 审批意见组件 -->
    <auditopinion v-if="isAudit" ref="auditopinion"></auditopinion>

    <div class="btn_btn">
      <el-button type="primary" v-if="isAudit" size="medium" class="m-left20" @click="examineFun">提交</el-button>
      <el-button type="primary" v-if="!isAudit" size="medium" class="m-left20" @click="addApplyFun">确认</el-button>
      <el-button size="medium" class="m-left20" @click="backFun">取消</el-button>
    </div>
  </div>
</template>
<script>
