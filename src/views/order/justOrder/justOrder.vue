    ...
    <div class="order_box">
        ...
        <el-card class="lvs">
            <div :class="'order_title '  +  (isShow ? '' : 'hide')">
                ...
                <div class="warp_head_list">
                    ...
                    <div class="head_nav_btn">
                        ...
                        <el-button size="medium" class="button-fc reset_btn" @click="resetFun">重置</el-button>
                    </div>
                </div>
                <div class="m-right" >
            ...
            <div class="order-btn-list">
                <el-button size="small" class="button-96" @click="addFun">新增订单</el-button>
                <el-button size="small" class="button-96" @click="downFun">批量下载</el-button>
                <el-button size="small" class="button-96" @click="importhFun">导入</el-button>
                <el-button size="small" class="button-96" @click="salesmanFun">指派业务员</el-button>
                <el-button size="small" class="button-96" @click="mechanismFun">指派机构</el-button>
                <el-button size="small" class="button-96" @click="saleFun">指派销售员</el-button>
            </div>
