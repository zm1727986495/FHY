<template>
  <div class="seemeasure">
    ...
    <el-card>
      <div class="modules">
        <div class="titlecals" style="margin-top: 0;">接单信息</div>
        <ul class="moduleContent">
          <li>带单号：{{ assistOrderInfo.assistNo }}</li>
          <li>推介门店：{{ assistOrderInfo.assistBrandName }}</li>
          <li>推介人：{{ assistOrderInfo.assistNo }}</li>
          <li>带单时间：{{ assistOrderInfo.assistTime }}</li>
          <li>原订单号：{{ assistOrderInfo.orderNumber }}</li>
          <li>带单品牌：{{ assistOrderInfo.assistBrandName }}</li>
          <li>带单品类：{{ assistOrderInfo.assistCommodityCategoryName }}</li>
          <li>带单备注：{{ assistOrderInfo.assistCommodityCategoryName }}</li>
      ...
      <div class="modules">
        ...
        <div class="moduleContent remarks">
          <span class="labelText">接单备注：</span>
          <p class="content">{{ assistOrderInfo.acceptRemarks }}</p>
        </div>
      </div>
      <!-- 订单详情 -->
