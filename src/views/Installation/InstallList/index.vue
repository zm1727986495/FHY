<template>
  <div class="installationList">
    ...
    <el-card class="m-bottom">
      ...
      <!-- table表格 -->
      <div class="table_list lvs attribute m-top5">
        ...
        :max-height="maxHeight" :row-key="getRowKeys" :data="tabList" style="width: 100%;">
          ...
          <el-table-column prop="purchaseContractCode" fixed='left' label="合同号" width="160" align="center" show-overflow-tooltip></el-table-column>
          ...
          <el-table-column prop="appointmentTime" label="任务上门时间" width="160" align="center"></el-table-column>

          <el-table-column prop="customerName" label="客户姓名" width="110" align="center"></el-table-column>

          <el-table-column prop="customerPhone" label="客户电话" width="120" align="center"></el-table-column>

          <el-table-column prop="address" label="订单地址" width="240" show-overflow-tooltip align="center"></el-table-column>

          <el-table-column prop="designer" label="设计师" width="110" align="center"></el-table-column>
          ...
          <el-table-column prop="leaderName" label="组长" width="120" align="center"></el-table-column>

          <el-table-column prop="workerName" label="工人" width="120" align="center"></el-table-column>

          <el-table-column prop="secondWorkerName" label="借调工人" width="120" align="center"></el-table-column>

          <el-table-column prop="appointmentRemake" label="上门备注" width="240" align="center"></el-table-column>

          <el-table-column prop="deliveryNumber" label="派货数量" width="110" align="center"></el-table-column>
          ...
          <el-table-column prop="designateSource" label="上门类型" width="110" align="center">
            <template slot-scope="scope">
              <div>
                <p v-if="scope.row.designateSource==1">上门安装</p>
                <p v-if="scope.row.designateSource==2">售后安装</p>
              </div>
            </template>
          </el-table-column>
...
import reportJournaldia from "./components/reportJournaldia"; //安装汇报
import picPreviewDia from "@/views/components/picPreviewDia"; //图片预览
import addreformdia from "@/views/entrepotSet/aftermarket/repairtask/components/addreformdia"; //添加改制
import revokedia from "@/views/entrepotSet/aftermarket/repairtask/components/revokedia";//撤销
import chargedia from "@/views/entrepotSet/aftermarket/repairtask/components/chargedia"; //添加收费
import searchinfo from "@/views/entrepotSet/aftermarket/repairtask/components/searchInfo"; //查询条件
import {
...
export default {
  ...
  data() {
    return {
      ...
      total: 0, //总条数
      actionBtnList: [
        //"导出", "安装汇报", "撤销", "添加改制", "收费", "定责"
        // {name:"导出",isShow:true,id:'1'},
        {name:"安装汇报",codename:'Installationlist_export',id:'2'},
        {name:"撤销",codename:'Installationlist_back',id:'3'},
        {name:"收费",codename:'Installationlist_money',id:'5'},
        {name:"定责",codename:'Installationlist_duty',id:'6'},
        {name:"改制",codename:'Installationlist_add',id:'4'},
      ],
      elsectVal: [],
      tabList: [],
      picList: [],
    ...
    butGroupActions(index) {
      ...
      if(index == '4'){
        if (this.canonlyFun()) {
          ...
          //   this.$message.warning("您安装汇报时选择了无需添加改制");
          //   return;
          // }
      ...
      if(index == '5'){
        if (this.canonlyFun()) {
          ...
          //   this.$message.warning("您安装汇报时选择了无需收费");
          //   return;
          // }
