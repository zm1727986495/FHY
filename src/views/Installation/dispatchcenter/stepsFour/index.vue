<template>
  <div class="pendingdisposal">
    ...
    <!-- <el-dialog
      title="返厂详情"
      :visible.sync="isReturnfactory"
      width="50%"
      :before-close="handleClose"
      custom-class="customDialogTitle"
    >
      <returnfactory v-if="isReturnfactory" :choseArr="choseArr" ref="returnfactory"></returnfactory>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="returnconfirmation">确 定</el-button>
        <el-button @click="handleClose">取 消</el-button>
      </span>
    </el-dialog>-->
    ...
    <div class="table_list lvs attribute" v-loading='loading'>
      ...
      >
        ...
        <el-table-column align="center" prop="evaluateStatus" label="满意程度" width="80"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      //按钮集合
      actionBtnList: [
        { name: "协同订单查询", type: 1, str: "dispatchcenter_Collaborative" },
        // { name: "赔偿", type: 3, str: "dispatchcenter_Compensate" },
        { name: "返厂", type: 4, str: "dispatchcenter_Returnfactory" },
        { name: "退货退款", type: 2, str: "dispatchcenter_Receipt" }
      ],
      // 按钮权限***********
      btnJurisdiction: JSON.parse(this.$loca.getItem("element")),
      isCollaborationsheet: false,
      isReturnfactory: false,
