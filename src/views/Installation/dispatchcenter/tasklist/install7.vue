    ...
    <!-- <el-card class="m-top20">
      <div class="search_box">
        <div class="search_item">
          <el-input v-model="name" class="width-100" placeholder="安装任务编号/申请人"></el-input>
        </div>
    ...
    <div class="table_list lvs attribute m-top20">
      <el-table border :data="tabList" style="width: 100%;">
       <el-table-column prop="name" label="编号" width="240" sortable align="center"></el-table-column>
        ...
        <el-table-column prop="name" label="货品名称" width="240" sortable align="center"></el-table-column>

        <el-table-column prop="name" label="产品品牌" width="240" sortable align="center"></el-table-column>

        <el-table-column prop="name" label="产品类别" width="240" sortable align="center"></el-table-column>

        <el-table-column prop="name" label="所属正单" width="240" sortable align="center"></el-table-column>

        <el-table-column prop="name" label="所属网点" width="240" sortable align="center"></el-table-column>

        <el-table-column prop="name" label="所属销售" width="240" sortable align="center"></el-table-column>
        
        <el-table-column prop="name" label="设计师" width="240" sortable align="center"></el-table-column>
