                ...
                <div>
                    <el-tooltip placement="right" visible-arrow v-if="btnJurisdiction.writeOff">
                        <div slot="content" class="tips tipFon">
                            <p class="operaItems" @click="jumpMoney(scope.row)">销账</p>
                        </div>
...
import {listOrder,writeOffOrderCollectMoney} from 'api/FinanceCenter/creditManagement/cancelAccount/index'
export default {
