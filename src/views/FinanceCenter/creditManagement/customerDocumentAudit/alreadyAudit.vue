                ...
                <div>
                    <el-tooltip placement="right" visible-arrow >
                        <div slot="content" class="tips tipFon">
                            <!-- <p class="operaItems" @click="goBack(scope.row)">驳回</p> -->
                            <p class="operaItems" @click="jumpMoney(scope.row)">收票</p>
                        </div>
                        <img :src="spot" alt="" class=" attributesTips">
                    </el-tooltip>
                    <p style="padding-left:20px;" class="operation table_action_span" @click="jumpList(scope.row)">{{scope.row.collectMoneyName}}</p>
                </div>
            </template>
            </el-table-column>
            <el-table-column
