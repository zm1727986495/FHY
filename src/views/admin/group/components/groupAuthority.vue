...
<el-row>
  ...
  <el-col :span="16" style='margin-top:15px;'>
    <el-table ref="elementTable" :data="list" border fit highlight-current-row @select="handleSelectionChange" style="width: 100%" class="jurisdictionTable">
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      let nodes = this.$refs.menuTree.getCheckedKeys().concat(this.$refs.menuTree.getHalfCheckedKeys())
