  ...
  <el-col :span="16" style='margin-top:15px;'>
    ...
    <el-form :label-position="labelPosition" label-width="80px" :model="form" ref="form">
      ...
      <el-form-item label="菜单类型" prop="type">
         <el-select class="filter-item" v-model="form.systemType"  :disabled="formEdit"  placeholder="请输入系统菜单类型">
          <el-option v-for="item in  systemType" :key="item.name" :label="item.name" :value="item.value"> </el-option>
        </el-select>
      </el-form-item>
