    ...
    >
      <div class="table_list lvs attribute m-top20">
        ...
        >
          ...
          <el-table-column prop="hisPrice" align="center" sortable label="历史价格"></el-table-column>
...
<script>
import { listAllRelCommodityPriceMoney } from "api/administrationCenter/salecost/priceguard/priceguard";
...
export default {
  ...
  methods: {
    //销售价历史价格列表
    getData(commodityPriceId) {
      let data = {
        commodityPriceId
      };
      listAllRelCommodityPriceMoney(data)
        .then(res => {
          if (res.status == 200) {
