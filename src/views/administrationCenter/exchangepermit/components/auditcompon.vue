        ...
        <!-- table表格 -->
                <div class="table_list lvs attribute m-top20">
                    ...
                    <el-table
                        ...
                        <el-table-column prop="name" align="center" label="换货状态" width="280" sortable>
            ...
            <!-- 点击审核记录的操作按耨--审核记录 -->
            <examinedia :visible="examVisible" @close_examin="examineclose" @examin_ok="examinok"  :orderApplyId="orderApplyId"></examinedia>
