    ...
    <div class="screencompon">
        <div class="warp_head_list">
            <div class="list_top">
                ...
                <div>
                    <el-select v-model="formline.applyStatus"  placeholder="选择状态" size="medium"  clearable filterable >
                        <el-option
                ...
                <div v-if="isShow">
                    <el-select v-model="formline.storeId" placeholder="选择所属门店" size="medium" clearable filterable >
                        <el-option
        ...
        <!-- table表格 -->
                <div class="table_list lvs attribute m-top20" v-loading="loading">
                    <el-table
                        ...
                        <el-table-column prop="applyStatus" label="申请状态"  sortable align="center" :formatter="statusformatter"></el-table-column>
                        <el-table-column prop="applyCode" label="备货申请单号" sortable align="center">
                            <template slot-scope="scope">
                                <div>
                                    <p class="table_action_span" @click="clickApplycode(scope.row)">{{ scope.row.applyCode }}</p >
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column prop="groupName" label="申请机构" sortable align="center"></el-table-column>
                        <el-table-column prop="createName" label="申请人"  sortable align="center"></el-table-column>
                        <!-- <el-table-column prop="applyRemark" label="申请理由"  sortable align="center" show-overflow-tooltip></el-table-column> -->
                        <el-table-column prop="createTime" label="申请时间" sortable align="center"></el-table-column>
                        <el-table-column prop="predictArrivalTime" label="预计到货日期" sortable align="center"></el-table-column>
                    </el-table>    
                </div>
                <!-- 分页 -->
    ...
    methods: {
        ...
        searchdatas(){
            return {
                ...
                predictArrivalStart: this.goodsData[1], // 预计到货起始时间
