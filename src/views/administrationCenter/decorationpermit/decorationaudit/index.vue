		...
		<el-card class="lvs">
            ...
            <auditcompon ref="auditcompon">
                <div class="btn_list_1">
                    ...
                    <el-button size="small" class="button-96" @click="exportFun"   v-if="btnJurisdiction.decorationaudit_export">导出</el-button>
                </div>
            </auditcompon>
      	</el-card>
    </div>
...
export default {
  ...
  // name: 'procurement',
	...
	// },
	// created() { 
    //     this.downFile = module.dev.proxyTable['/api'].target + '/api/pc/homeCollectionApply/exportHomeCollectionApply?orderApplyIds=';
    // },
    activated(){
        // 头部面包屑
        this.navList = this.$route.meta;
