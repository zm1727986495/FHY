		...
		<el-card class="lvs">
            ...
            <querycompon ref="querycom">
                <div class="btn_list_1">
                    <el-button size="small" class="button-96" @click="addApply"   v-if="btnJurisdiction.decorationapply_add">新增申请</el-button>   
                    <!-- <el-button size="small" class="button-96" @click="printFun">打印</el-button>  -->
                    <el-button size="small" class="button-96" @click="exportFun"   v-if="btnJurisdiction.decorationapply_export">导出</el-button>
                </div>
            </querycompon>
      	</el-card>
    </div>
...
export default {
  ...
  // name: 'procurement',
	...
	methods: {
        ...
        addApply() {
            this.$router.push({
                path: "/decorationpermit/addapplication",
                query: {
                    pageStatus: "8",
                }
            })
