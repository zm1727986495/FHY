                ...
                <div class="stockfrom">
                    <el-form
                        ...
                        <el-form-item label="申请单号" required prop="organ"  >
                            <el-input v-model="stock.organ" size="medium"  disabled placeholder="申请单号"></el-input>
                        </el-form-item>

                        <el-form-item label="申请类型" required prop="type"  >
                            <el-input v-model="stock.type" size="medium"  disabled placeholder="申请类型"></el-input>
                        </el-form-item>

                        <el-form-item label="审批人" required prop="auditer"  >
                            <el-input v-model="stock.auditer" size="medium" disabled placeholder="审批人"></el-input>
                        </el-form-item>

                        <el-form-item label="是否使用审批次数" required prop="isAudit">
                            <el-select v-model="stock.isAudit" placeholder="是否使用审批次数" disabled>
                                <el-option
                        ...
                        <el-form-item label="已用次数" required prop="usedNum"  >
                            <el-input-number v-model="stock.usedNum" disabled :step="2" step-strictly :min="0"></el-input-number>
                        </el-form-item>

                        <el-form-item label="审批次数" required prop="auditNum"  >
                            <el-input-number v-model="stock.auditNum" disabled :step="2" step-strictly :min="0"></el-input-number>
                        </el-form-item>

                        <!-- <el-form-item label="每月审批次数" required prop="audittotalNum"  >
                            <el-input-number v-model="stock.audittotalNum" disabled :step="2" step-strictly :min="0"></el-input-number>
                        </el-form-item> -->
                        ...
                        <el-form-item
                         ...
                         <el-form-item label="特批折扣" required prop="discount"  >
                            <el-input v-model="stock.discount" size="medium" disabled placeholder="特批折扣"></el-input>
                        </el-form-item>

                        
                        <el-form-item label="预计交货日期" required prop="endTime">
                        <el-date-picker
