    ...
    <div class="m-top20">
      ...
      <div class="table-width lvs attribute">
        ...
        >
          ...
          <el-table-column align="center" prop="specification" label="商品规格" width="150"></el-table-column>
          <el-table-column align="center" prop="commodityModel" label="商品型号" width="150"></el-table-column>
          <el-table-column align="center" prop="availableInventory" label="商品数量" width="150"></el-table-column>
          <el-table-column align="center" label="领用数量" width="150">
            <template slot-scope="scope">
              <div>
                <el-input size="small" @input="appropriation(scope.row)" v-model="scope.row.recipientsNum"></el-input>
              </div>
            </template>
          </el-table-column>
