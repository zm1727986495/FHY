    ...
    <div class="apper">
        <div class="search_box">
          <div class="search_item">
						<el-input	placeholder="订单号/合同号/采购合同号" v-model="searchForm.text" size="medium" class="width-100"></el-input>
          </div>
          <div class="search_item">
						<el-date-picker
          ...
          <div class="search_item">
            <el-select v-model="searchForm.storeId" placeholder="所属门店" size="medium" class="width-100">
							<el-option v-for="item in listStoreList" :key="item.storeId" :label="item.storeName" :value="item.storeId"></el-option>
						</el-select>
          </div>
					<div class="search_item">
						<el-select v-model="searchForm.brandId" placeholder="选择商品品牌" size="medium" :disabled="isInside">
								<el-option
					...
					<div class="search_item">
						<el-select v-model="searchForm.categoryId" placeholder="选择商品品类" size="medium" :disabled="isInside">
								<el-option
        ...
        <div class="table_list lvs attribute">
			  ...
			  max-height="400" :data="tabList" style="width: 100%;">
				<el-table-column type="selection"></el-table-column>
				<el-table-column prop="orderNumber" label="订单号" width="120" align="center"></el-table-column>
				<el-table-column prop="factoryContractNo" label="采购合同号" width="140" align="center"></el-table-column>
				<el-table-column prop="createTime" label="订单创建时间" width="160" align="center"></el-table-column>
				<el-table-column prop="storeName" label="所属门店" width="120" align="center" show-overflow-tooltip></el-table-column>
				<el-table-column prop="status" label="状态" width="120" align="center" :formatter="statusformatter"></el-table-column>
				<el-table-column prop="storageName" label="所属仓库" width="120" align="center"></el-table-column>
...
export default {
  ...
  data() {
	...
	created() {
		if(this.clickType == 'inside') {
			this.searchForm.brandId = this.brandId, // 品牌
			this.searchForm.categoryId = this.categoryId,  // 品类
			this.isInside = true;
		}
		// 查询订单库存查询列表 -- 即订单列表
    ...
    resetFun(){
		...
		listStoragePurchaseOrderByPage() {
			let data = {
				...
				brandId: this.searchForm.brandId ? this.searchForm.brandId : null, // 品牌
                categoryId:  this.searchForm.categoryId ? this.searchForm.categoryId : null, // 品类
