<template>
  <div class="procurement" v-if="tableList.length!=0">
    ...
    <div class="orderList m-top10">
      <div v-for="(item,index) in tableList" :key="index">
        <div
          class="order_item m-bottom"
          v-if="item.unpackingDataVOS&&item.unpackingDataVOS.length!==0"
        >
          <div class="item_header">
            <div class="purchase">
              <span class="span_title span_title0">采购单号：</span>
              <span>{{item.purchaseNumber}}</span>
            </div>
            <div class="purchase">
              <span class="span_title span_title0">采购合同号：</span>
