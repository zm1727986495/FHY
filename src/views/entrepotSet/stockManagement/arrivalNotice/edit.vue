<template>
  <div>
    ...
    <div class="btn">
      <el-button v-if="!isShow" type="primary" @click="submission">提 交</el-button>
      <el-button v-if="!isShow" type="warning" @click="preservation">保 存</el-button>
...
import editInformation from "./message/editInformation";
import editprocurement from "./message/editprocurement";
import {
  editArrivalNotice,
  submitArrivalNotice,
