  ...
  <div class="repaircom2">
    <!-- <el-card class="m-top20">
      <div class="search_box">
        <div class="search_item">
          <el-input
            v-model="searchform.installationGroup"
            class="width-100"
            placeholder="维修任务编号/任务编号/员工编号/电话"
          ></el-input>
        </div>
    ...
    <div class="table_list lvs attribute m-top20">
      <el-table border :data="tabList" style="width: 100%;" :row-class-name="tableRowClassName">
        ...
        <el-table-column prop="installReportPic" label="维修汇报照片" width="240" sortable align="center">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    //时间改变回调
    dataChange() {
      this.searchform.reportSrartTime = this.time1 ? this.time1[0] : "";
      this.searchform.reportEndTime = this.time1 ? this.time1[1] : "";
    },
