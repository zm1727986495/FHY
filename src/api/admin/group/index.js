...
export function listGroupUser(params) {
  return fetch({
    url: '/api/admin/authority/listGroupUser',
    method: 'get',
    params
  });
}
...
export function getUserGroup(params) {
  return fetch({
    url: '/api/admin/authority/getUserGroup',
    method: 'get',
    params
  });
}
export function editRoleGroup(data) {
  return fetch({
    url: '/api/admin/authority/editRoleGroup',
    method: 'put',
    data
  });
}
export function editUserGroup(data) {
  return fetch({
    url: '/api/admin/authority/editUserGroup',
    method: 'put',
    data
  });
}
export function editGroupUser(data) {
  return fetch({
    url: '/api/admin/authority/editGroupUser',
    method: 'put',
    data
  });
}
